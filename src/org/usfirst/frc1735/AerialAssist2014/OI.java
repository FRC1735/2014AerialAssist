...
public class OI {
    ...
    public static double humanShotStrength = 1.0;
    public static double humanShotPotMax = 175;
    public static double cornerShotStrength = 1.0;
    public static double cornerShotPotMax = 175;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // Two new functions for STL allow different shot strength/angle for shooting to human player and shooting from corner in front of low goal:
        // These vars are for tuning the values.
        SmartDashboard.putNumber("HumanShotStrength", humanShotStrength);
        SmartDashboard.putNumber("HumanShotPotMax", humanShotPotMax);
        SmartDashboard.putNumber("CornerShotStrength", cornerShotStrength);
        SmartDashboard.putNumber("CornerShotPotMax", cornerShotPotMax);
